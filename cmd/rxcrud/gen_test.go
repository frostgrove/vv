...
func gen(t *testing.T, files map[string]string, tweak func(*generator)) string {
	...
	g := &generator{
		...
		withDTO:  true,
		withMeta: true,
		specsPkg: "github.com/shardit-io/qq/repo/decorators/specs",
		crudPkg:  "github.com/shardit-io/qq/crud",
	}
	if tweak != nil {
		tweak(g)
	}
...
func TestGeneratingOnlyOneHalf(t *testing.T) {
	...
	if strings.Contains(noDTO, `"github.com/shardit-io/qq/crud"`) {
