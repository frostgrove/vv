// Command ent-pgx-gin is rx-crud with ent, pgx's database/sql driver and the
// Gin binding.
//
...
// entstore.Product_ are generated from that entity by cmd/rxcrud; see
...
func main() {
	...
	// afterwards. Neither owns the connection; rx-crud never dials one itself.
