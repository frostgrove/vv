...
func (this *Queries) WithTx(tx pgx.Tx) *Queries { return &Queries{database: tx} }
...
func (this *Queries) CreateUser(ctx context.Context, arg CreateUserParams) (User, error) {
	row := this.database.QueryRow(ctx, createUser, arg.TenantID, arg.Email, arg.Name, arg.Age, arg.Active)
	var i User
...
func (this *Queries) GetUser(ctx context.Context, id int64) (User, error) {
	row := this.database.QueryRow(ctx, getUser, id)
	var i User
	err := row.Scan(&i.ID, &i.TenantID, &i.Email, &i.Name, &i.Age, &i.Active, &i.CreatedAt)
	return i, err
}
...
func (this *Queries) CountUsersByTenant(ctx context.Context, tenantID int64) (int64, error) {
	row := this.database.QueryRow(ctx, countUsersByTenant, tenantID)
	var count int64
	err := row.Scan(&count)
	return count, err
}
