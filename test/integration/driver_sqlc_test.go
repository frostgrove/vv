...
import (
	...
	"github.com/shardit-io/qq/test/sqlcgen"
	"github.com/shardit-io/qq/test/sqlcmysql"
	"github.com/shardit-io/qq/test/sqlcpgx"
)
...
func TestSqlcDatabaseSQLPostgres(t *testing.T) {
	...
	if got.Name != "BySqlc" {
		t.Fatalf("github.com/shardit-io/qq read back %+v", got)
	}
