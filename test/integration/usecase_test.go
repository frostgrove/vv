...
import (
	...
	entpkg "github.com/shardit-io/rx/test/ent"
	entuser "github.com/shardit-io/rx/test/ent/user"
	"github.com/shardit-io/rx/test/entstore"
)
...
func TestGormUsecaseRollsBackBothHalves(t *testing.T) {
	...
	if n, _ := members.Count(ctx); n != 1 {
		t.Fatalf("github.com/shardit-io/rx's write survived the rollback: count = %d", n)
	}
}
