...
var Notes = sqlrepo.Define[Note, int64, NoteUpdate]("notes")
...
func TestTheDeclarationAGeneratorProducesForAVersionedModelIsAccepted(t *testing.T) {
	...
	if _, err := sqlrepo.TryDefine[Doc, int64, DocUpdate]("docs"); err != nil {
	...
	if _, err := sqlrepo.TryDefine[Doc, int64, WithLock]("docs"); err == nil {
