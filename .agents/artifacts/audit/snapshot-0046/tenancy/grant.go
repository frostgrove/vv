...
// wildcard cohort and no empty one: a grant that names nobody would be the second
// way to disable narrowing, and the whole point of INV-2 is that there is one.
