...
| [2026-09-08-magic-first-dx-mechanics.md](2026-09-08-magic-first-dx-mechanics.md) | 59 framework-mechanism cards: DX, runtime guarantees, access and operations; 24 new unimplemented proposals with sources and verified baselines. CMS excluded; Temporal remains a native SDK integration |
...
| [2026-09-01-i18n-roadmap.md](2026-09-01-i18n-roadmap.md) | Research revision 2026-09-08: 12 i18n mechanisms and 7 integration contracts for modules, errs/transports, tenancy, OTel, cache, jobs and catalogue lifecycle; verified baseline, cross-language references, illustrative DX and combined delivery gates; event sourcing excluded |
| [2026-09-01-postgres-event-sourcing-roadmap.md](2026-09-01-postgres-event-sourcing-roadmap.md) | Delivered root event vocabulary/store seam and proposed PostgreSQL store under `event/eventpg`; E0–E4 gates preserved. Research appendices 2026-09-08: 9 explicitly unimplemented subscription/projection/replay/recovery mechanisms; no workflow engine |
