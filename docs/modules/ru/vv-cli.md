...
Подкоманд три, и они пишут разные артефакты:
...
- [[UC-014]] держать сгенерированные артефакты в синхронизации · [[FL-010]] от модели к DTO и метамодели · [[FL-029]] от модели к публичному wire-телу
- [[D-018]] DTO и метамодели генерируются · [[D-050]] сгенерированный адаптер тотален · [[D-105]] persistence-патч — не публичное тело
