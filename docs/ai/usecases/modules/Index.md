...
| cache | `github.com/frostgrove/vv/cache` · `github.com/frostgrove/vv/cache/cachememory` · `github.com/frostgrove/vv/cache/cachefx` | [Cache](cache/Cache.md) | [UC-024](cache/UC-024-cache-recreatable-values-without-unbounded-work.md) | ready for bounded process caching |
...
| audit | — | — | [UC-034](audit/UC-034-record-and-investigate-auditable-evidence.md) | S0 contract only; no runtime package or readiness sweep yet |
| i18n | `github.com/frostgrove/vv/i18n` | [I18n](i18n/I18n.md) | [UC-033](i18n/UC-033-render-one-message-correctly-now-or-later.md) | ready for bounded in-process presentation; external lifecycle is application-owned |
